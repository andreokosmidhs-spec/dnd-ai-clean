...
CLASS_FEATURES_BY_LEVEL: Dict[str, Dict[int, List[Dict]]] = {
    ...
    "Cleric": {
        ...
        18: [
            {"name": "Channel Divinity (3/rest)", "rarity": "rare",
             "description": "You can now use Channel Divinity three times per short or long rest.",
             "mechanical": "3/short or long rest", "per_day": False, "uses_max": 3},
        ],
        19: [_ASI],
        20: [
