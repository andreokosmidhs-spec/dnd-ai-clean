...
SPELL_REQUIREMENTS: Dict[str, Dict[str, Any]] = {
    ...
    # spell_type: "attack" = attack-roll, "heal" = healing, "auto_hit" = no roll, "buff" = utility
    "Eldritch Blast":  {"components": _VS, "range": "120 ft", "duration": "instantaneous",
                        "spell_type": "attack", "damage_dice": "1d10", "damage_type": "force"},
    "Fire Bolt":       {"components": _VS, "range": "120 ft", "duration": "instantaneous",
                        "spell_type": "attack", "damage_dice": "1d10", "damage_type": "fire"},
    ...
    "Guidance":        {"components": _VS, "range": "touch",  "duration": "1 min",
                        "concentration": True, "spell_type": "buff"},
    "Shillelagh":      {"action_cost": "bonus_action",
                        "components": _M("mistletoe, shamrock leaf, club or staff"),
                        "range": "touch", "duration": "1 min", "spell_type": "buff"},
    "Produce Flame":   {"components": _VS, "range": "self",   "duration": "10 min",
                        "spell_type": "attack", "damage_dice": "1d8", "damage_type": "fire"},
    "Thorn Whip":      {"components": _M("plant stem"), "range": "30 ft", "duration": "instantaneous",
                        "spell_type": "attack", "damage_dice": "1d6", "damage_type": "piercing"},
    "Mage Hand":       {"components": _VS, "range": "30 ft",  "duration": "1 min", "spell_type": "buff"},
    "Minor Illusion":  {"components": _SM("bit of fleece"), "range": "30 ft", "duration": "1 min",
                        "spell_type": "buff"},
    "Prestidigitation":{"components": _VS, "range": "10 ft",  "duration": "1 hour", "spell_type": "buff"},
    "Shocking Grasp":  {"components": _VS, "range": "touch",  "duration": "instantaneous",
                        "spell_type": "attack", "damage_dice": "1d8", "damage_type": "lightning"},
    "Chill Touch":     {"components": _VS, "range": "120 ft", "duration": "1 round",
                        "spell_type": "attack", "damage_dice": "1d8", "damage_type": "necrotic"},
    "Ray of Frost":    {"components": _VS, "range": "60 ft",  "duration": "instantaneous",
                        "spell_type": "attack", "damage_dice": "1d8", "damage_type": "cold"},
    "Thaumaturgy":     {"components": _V,  "range": "30 ft",  "duration": "1 min", "spell_type": "buff"},
    ...
    "Magic Missile":   {"components": _VS, "range": "120 ft", "duration": "instantaneous",
                        "spell_type": "auto_hit", "damage_dice": "1d4+1", "damage_type": "force"},
    ...
    "Hex":             {"action_cost": "bonus_action",
                        ...
                        "range": "90 ft", "duration": "1 hour", "concentration": True, "spell_type": "buff"},
    "Armor of Agathys":{"components": _M("a cup of water"),
                        "range": "self",  "duration": "1 hour", "spell_type": "buff"},
    ...
    "Hunter's Mark":   {"action_cost": "bonus_action",
                        "components": _V,  "range": "90 ft",  "duration": "1 hour",
                        "concentration": True, "spell_type": "buff"},
    "Divine Favor":    {"action_cost": "bonus_action",
                        "components": _VS, "range": "self",   "duration": "1 min",
                        "concentration": True, "spell_type": "buff"},
    ...
    "Speak with Animals":{"components": _VS, "range": "self", "duration": "10 min",
                        "ritual": True, "spell_type": "buff"},
    "Detect Magic":    {"components": _VS, "range": "self",   "duration": "10 min",
                        "concentration": True, "ritual": True, "spell_type": "buff"},
    ...
    "Ensnaring Strike":{"action_cost": "bonus_action",
                        "components": _V,  "range": "self",   "duration": "1 min",
                        "concentration": True, "spell_type": "buff"},
    "Witch Bolt":      {"components": _M("a twig struck by lightning"),
                        "range": "30 ft", "duration": "1 min", "concentration": True,
                        "spell_type": "attack", "damage_dice": "1d12", "damage_type": "lightning"},
    ...
    "Scorching Ray":   {"components": _VS, "range": "120 ft", "duration": "instantaneous",
                        "spell_type": "attack", "damage_dice": "2d6", "damage_type": "fire"},
    "Mirror Image":    {"components": _VS, "range": "self",   "duration": "1 min", "spell_type": "buff"},
...
def get_spell_card(spell_name: str) -> Dict[str, Any]:
    ...
    return {
        ...
        # Spell type routing ("attack", "heal", "auto_hit", "buff", or None for save-spells/weapons)
        "spell_type": reqs.get("spell_type"),
