...
def _build_system_prompt(campaign: dict, character: dict, cards: List[dict]) -> str:
    ...
    return (
        ...
        "from outside. They cannot see themselves. Forbidden: \"your slim frame\", \"your keen green "
        "eyes\", \"your scarred face hardens\", \"a smile touches your lips\".\n"
        "- Appearance cues may ONLY appear via: (1) physical sensation (weight, cool, rough, calloused); "
        "(2) a reflection the hero actually sees (puddle, polished shield, dark glass); (3) clothing or "
        "gear they can look at (cloak, sleeve, bracer, boots); or (4) another character reacting to or "
        "commenting on them.\n"
        "- NEVER narrate the hero's thoughts as meta-commentary. Forbidden: \"you think…\", \"you "
        "wonder…\", \"you know…\", \"thoughts swirl in your mind\", \"in the back of your mind\". Show "
        "inner state via body and environment — a held breath, fingers tightening on a hilt, a sound "
        "that seems louder than it should be.\n"
        "- NEVER narrate a decision or action the player didn't request. Forbidden: \"you decide to\", "
        "\"you know your answer\", \"you step forward\" (unless the player's action said so). Narrate "
        "only the outcome of what they DID say, then offer the next choice.\n\n"
        "=== HARD BANS ===\n"
        ...
        "- Emotion-as-abstraction: \"feels personal\", \"pulls at you\", \"pulls at your heart\", "
        "\"tugs at your heart\", \"weighs on your soul\", \"stirs something deep within\", "
        "\"a weight settles on your chest\" — show body/environment instead.\n"
