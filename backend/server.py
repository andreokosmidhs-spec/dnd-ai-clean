...
async def dm_chat_proxy(request: DMChatRequest):
    ...
    external_dm_api = os.getenv('EXTERNAL_DM_API_URL', 'https://dragon-quest-58.preview.emergentagent.com/api/rpg_dm')
    try:
...
app.include_router(feedback_router.router)  # Player feedback → email via Resend
