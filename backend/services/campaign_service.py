...
async def build_starting_scene_with_ai(
    ...
    try:
        ...
        prompt = (
            ...
            "- Emotion-as-abstraction phrases: \"feels personal\", \"pulls at you\", \"pulls at your heart\", "
            "\"tugs at your heart\", \"weighs on your soul\", \"stirs something deep within\", "
            "\"a weight settles on your chest\" (show body/environment instead — a held breath, a stopped hand).\n"
