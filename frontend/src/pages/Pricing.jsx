...
const PLANS = [
  {
    ...
    features: [
      "100 turns per month",
      "Full AI DM narration",
      "All character classes & races",
      "Balanced & Heroic narrator tones",
      "Narration voice (browser TTS)",
      "Session adventure journal",
  ...
  },
  {
    ...
    features: [
      "600 turns per month",
      "Everything in Free",
      "AI scene images after each narration",
      "All 5 narrator tones (Gritty · Dark · Comedic)",
      "Story Consistency AI layer",
      "Quest tracking & world map",
